...
@SpringBootTest
class BootGeneratorApplicationTests {
    ...
    void contextLoads() {
        ...
        // 全局变量配置(/Users/laiwen/Desktop/work/develop/workspace/mudxx/mall-learning-projects/mudxx-demo/mudxx-demo-boot-generator)
        GlobalConfig gc = new GlobalConfig();
        String projectPath = "/Users/laiwen/Desktop/work/develop/workspace/mudxx/mall-learning-projects/mudxx-demo/mudxx-demo-boot-generator";
        ...
        pc.setParent("com.mudxx.demo.boot.generator.project");
        pc.setModuleName("demo"); //此处是所属模块名称
...
//        Map<String, String> pathInfo = MapUtil.newHashMap();
//        pathInfo.put("bo", "com.mudxx.demo.boot.generator.project.bo");
...
//      sc.setTablePrefix("com_"); // 生成的实体类去除表前缀
        sc.setInclude("agw_account"); // 表名，用，隔开  需要生产
